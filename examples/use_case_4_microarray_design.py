#!/usr/bin/env python3
"""
FOREST Use Case 4: DNA Barcode Microarray Design

Generate DNA barcode sequences for microarray design compatible with RNA probes.
This creates the DNA barcode strands that capture RNA probes for multiplexed
affinity assays and functional RNA element identification.

Usage:
    python examples/use_case_4_microarray_design.py --input examples/data/test.fa.txt --barcodes examples/data/barcode25mer_100000.txt --num_barcodes 3
    python examples/use_case_4_microarray_design.py --input examples/data/test_100.fa.txt --barcodes examples/data/barcode25mer_100000.txt --num_barcodes 2
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Design DNA barcode microarray using FOREST algorithm",
    ...
    print("Output: DNA barcode microarray sequences")
    print("-" * 50)
